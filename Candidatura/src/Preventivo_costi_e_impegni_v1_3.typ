...
#show: project.with(
  ...
  date: "06/11/2024",
  versionamento: (
    "1.3", "06/11/2024", "Ion Cainareanu", "Modifica capitolato scelto causa riassegnazione da parte del proponente","Marco Perazzolo","Stefano Baso",
...
A seguito del rifiuto del proponente nell'aggiudicazione del capitolato precedene, abbiamo elaborato il preventivo per la proposta dell'azienda *Bluewind s.r.l.* riguardante il progetto *Requirement Tracker - Plug-in VS Code*.
...
= Giustificazione della conformità del preventivo
A seguito di un'attenta analisi da parte dei membri del gruppo e considerando anche che le ore per ogni membro sono rimaste invariate, abbiamo ricavato una suddivisione oraria dei ruoli uguale al preventivo del capitolato precedente. Ciò comporta un prezzo totale di *10.980,00 €*.
...
= Preventivo
Considerando le ore produttive messe a disposizione da ciascun membro del gruppo e la loro distribuzione tra i diversi ruoli, il totale del preventivo ammonta a *10.980,00 €*.
