...
== Discussione sui diagrammi UML
Sono stati mostrati i diagrammi uml, dapprima discutendone graficamente e successivamente della loro suddivisone. E' stato analizzato nel dettaglio il raggruppamento dei vari use case, partendo dal diagramma generale per poi proseguire con i vari sottoinsiemi, verificando per ognuno il grado di separazione e specificità. 

== Assegnazione compiti
Sono stati definiti gli utlimi task da fare prima della consegna, dando priorità alla verifica e integrazione del nuovo template. Sono state proposte alcune date per l'incontro di discussione dei documenti e della data di consegna ma con il rimando della decisione finale al prossimo incontro.
